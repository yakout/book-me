            ...
            <form class="form" role="form" autocomplete="off" method="post" action="/profile">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"
                           value="<%= ((User) session.getAttribute("user")).getEmail()%>" id="ISBN"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" id="publisher" name="publisher"
                           placeholder="Book Publisher" required>
                </div>

                <div class="form-group">
                    <label for="pub_year">Publication Year</label>
                    <input type="text" class="form-control" value="" id="pub_year" name="pub_year"
                           placeholder="Publication Year" required>
                </div>

                <div class="form-group">
                    <label for="threshold">Threshold</label>
                    <input type="text" class="form-control" value=""  id="threshold" name="threshold"
